...
// Brand accent used across the carousel (indigo). Change here to rebrand.
const ACCENT = "#6366F1";

// Web-development studio capabilities.
const FEATURES = [
  {
    id: "product-design",
          ...
          <div className="relative w-full max-w-[420px] aspect-[4/5] flex items-center justify-center">
            {FEATURES.map((feature, index) => {
              ...
              return (
                ...
                >
                  {/* Brand gradient fallback (visible if the photo fails to load) */}
                  <div
                    className="absolute inset-0"
                    style={{
                      background:
                        "linear-gradient(135deg, hsl(245 62% 30%), hsl(262 70% 22%))",
                    }}
                  />
                  <img
                    src={feature.image}
